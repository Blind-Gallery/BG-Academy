...
<head>
    ...
    <title>Welcome to Academy by Blind Gallery</title>
</head>
<style>
...
<body>
    ...
    <div class="container">
        <div class="logo"> <svg width="345px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1465.09 333.79">
                <defs>
                    <style>
                        .cls-1 {
                            fill: #00b9cd;
        ...
        <hr>
        <h1 style="color:#00b9cd">Welcome to Academy</h1>
        <p>We are excited to have you as part of our online learning platform. With Academy, you can access a wide
            variety of courses and learn at your own pace.</p>
        <p>Some of the features we offer include:</p>
        <ul>
            <li>High-quality courses taught by experts.</li>
            <li>Certificates that you can mint on the Tezos blockchain.</li>
            <li>Tracking of your progress.</li>
        </ul>
        <p>Start your learning journey <a href="https://academy.blindgallery.xyz/" target="_blank">here!</a></p>
        <p><i>Blind Gallery Team</i></p>

        <footer>
            <div style="display:flex; gap:0.25rem; align-items: center; width: 100%; justify-content: center;">
                <p style="font-size: small;">Powered by</p>
                <div><svg id="Layer_1" width="55px" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 683.89 237">
                        <defs>
                            <style>
                                .cls-6 {
                                    fill: #262d33;
