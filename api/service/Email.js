    ...
    <div style="display: flex; justify-content: center; height: 100vh; align-items: center;">
        <div class="parent-container">
            <div class="welcome-container">
                ...
                <p style="margin: 0;">Welcome to the Academy by Blind Gallery</p>
            </div>
            <div class="link-container">
                <div> <svg width="345px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1465.09 333.79">
                        <defs>
                            <style>
                                .cls-1 {
                                    fill: #00b9cd;
                ...
                <hr style="width: 90%; margin: 1.5rem 0rem;">
                <h3 style="font-weight: 400; margin: 0;">You can access our platform <a style="color: #00b9cd;"
                        href="https://qa-bg-academy-client-c92169fac952.herokuapp.com/" target="_blank">here</a></h3>
            </div>
            <p style="font-size: small;"><i>Blind Gallery Team</i></p>
        </div>
    </div>
</body>
</html>
