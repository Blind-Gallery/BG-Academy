...
const { update_operators_call } = require('./update-operators')
const { set_pause_call } = require('./pause-contract')
...
async function update_operators() {
  ...
  await update_operators_call()
}

async function update_operators_github() {
